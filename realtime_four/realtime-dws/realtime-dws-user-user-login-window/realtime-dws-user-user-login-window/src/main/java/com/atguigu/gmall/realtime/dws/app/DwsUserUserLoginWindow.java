...
/**
 * @author name 婉然从物
 * @create 2024-06-08 10:46
 */
public class DwsUserUserLoginWindow extends BaseApp {
    public static void main(String[] args) {
        new DwsUserUserLoginWindow().start(10025, 4, "dws_user_user_login_window", Constant.TOPIC_DWD_TRAFFIC_PAGE);
    }
    @Override
...
//        reducebeanStream.print();
    ...
    private static SingleOutputStreamOperator<UserLoginBean> windowAndAgg(SingleOutputStreamOperator<UserLoginBean> uuCtBeanStream) {
    ...
    private static SingleOutputStreamOperator<UserLoginBean> getBackctAndUuctBean(KeyedStream<JSONObject, String> keyedStream) {
...
//                }
    ...
    private static KeyedStream<JSONObject, String> getKeyedStream(SingleOutputStreamOperator<JSONObject> withWatermarkStream) {
    ...
    private static SingleOutputStreamOperator<JSONObject> getWithWatermarkStream(SingleOutputStreamOperator<JSONObject> jsonObjStream) {
